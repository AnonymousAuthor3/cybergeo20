...
terms2 = read.csv("data/kwprop.csv", sep=",", dec=".")
terms1 = read.csv("data/docprobas2.csv", sep=",", dec=".")
load("data/themesLDA.Rdata")
files$name = NULL
files$path = NULL
terms3 = read.csv("data/20themes20words.csv", sep=",", dec=".")
nameThemes = c(as.character(terms3$NAME), "Other")
...
themeNamesJ = colnames(terms1)[2:13]
themeNamesH = colnames(terms2)[2:11]
