...
citationProbas <- terms1[terms1$CYBERGEOID!=0&!is.na(terms1$CYBERGEOID),2:13]
rownames(citationProbas)<-terms1$CYBERGEOID[terms1$CYBERGEOID!=0&!is.na(terms1$CYBERGEOID)]
